...
export const getWorkerPIDs = a => Object
  .keys(cluster.workers).map(w => cluster.workers[w].process.pid);

export const numWorkers = a => Object.keys(cluster.workers).length;

export const workerByIndex = i => cluster.workers[Object.keys(cluster.workers)[i]];
